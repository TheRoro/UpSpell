<template>
  <div class="h-screen">
    <Banner title="UpSpell" sub-title="Special Characters for all languages!" />
    <div class="bg-dark grid xs:grid-cols-1 sm:grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 px-10 py-14">
