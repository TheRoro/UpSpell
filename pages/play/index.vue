<template>
  <div class="min-h-screen">
    <Banner title="Daily Spell" sub-title="Pick the right accent!" />
...
// Get today's word index based on date
...
const shuffledChoices = computed(() => {
  if (!todayWord.value) return []
  // Shuffle choices but keep them deterministic per day
...
function guess(choice: string) {
  ...
  // First choice in the original array is always the correct answer
